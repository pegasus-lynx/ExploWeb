...
export const RecDetails: RecommenderDetail[] = [
    {
        ...
        schemaImage: "../../../assets/"
        features : ["Emerging topics identification","Search literatures","Search top authors,top venues","Identification of datasets and algorithm","Active area identification"]
    },
    {
        id: 2,
        name: "LitRec",
    ...
    features : ["Search key literatures","Identify problem statements","Related reasearch papers"]
    },
    {
        id: 3,
        name: "EAR",
        ...
        longDescription: `Recommendation System for Technical paper reviewer assignment is very important for many applications especially in the academic environment and industry. Previous work to build the expert finding system based on a paper title. Here we take a scenario of a conference where they need some experts who can review the paper for that we identify whether the reviewer is expert in that topic or domain to review the paper.Scientific conference management involves many complex and multi-faceted activities, which would make highly desirable for the organizing people to have a Web-based management system that makes some of them a little easier to carry out. One of such activities is the assignment of submitted papers to suitable reviewers, involving the authors, the reviewers and the conference chair. Authors that submit the papers usually must fill a form with paper title, abstract and a set of conference topics that fit their submission subject. Reviewers are required to register and declare their expertise on the conference topics (among other things). Finally, the conference chair has to carry out the review assignment taking into account the information provided by both the authors (about their paper) and the reviewers (about their competencies). `,
         schemaImage: "../../../assets/ear.png"
    features : ["Expert identification","Automatic reviewers assignment","Reviewers for proposals"]
    },
    {
        id: 4,
        name: "RPRS",
        ...
        longDescription: `Peer review is an essential part of scientific communications. Scientific manuscripts and research proposals are reviewed by several peer scientists for publication and funding respectively.cite{benos2007ups}.
In recent years, information overload in scholarly big data, has made it challenging to extract uselful and effective information~\cite{george2014big}. Rapid development have been witnessed in the scale of academic entities such as researchers, publications and scholarly venues. This phenomenon has not only created ample opportunities for researchers but also gave birth to new challenges, especially in the area of peer reviewing system for managing peer review process. Different recommender systems on peer review platform is, therefore, an emerging research area.
...
The rapid growth of data volume and variety requires more advanced tools to help with academic data's exploration, and huge effort has been dedicated to facilitate various types of meaningful applications. Representative works include: reference recommendation, scholars' profiling and academic impact estimation. In addition to the above applications, peer review mining and recommendation has been regarded as an useful application in exploiting academic reviews, which aims to provide an appropriate review specific scores for individual reviews. Inspite of finding individual review sepecific scores, theere is a need of system which can help to decide the final decision of a paper based on the reviews of assigned reviewers. Consequently, obtaining useful and effective information from individual reviews which can influence the overall recomemndation, has become a complex task. Studies confirm that there is a strong relationship between sentiment analysis of reviews and the final recomemndation of the manucript.`,
    ...
    features : ["Overall rating of a paper",
    ...
    features : ["Suitable journals identification","High quality conferences"]
    },
    {
        id: 7,
        name: "DRACoR",
...
To recommend the most influential collaborator for researchers, we need to focus our study from the perspective of a researcher's needs and development of the particular research area pertaining to the following issues.Who are the most prolific and active researchers who can provide professional academic guidance for a target researcher.How to obtain researchers who are having relevant research interest with target researcher.How to capture rapidly and temporarily changing nature of research trends and research interest of individual researchers?.`,
    ...
    features : ["Most potential collaborators(MPCs)","Most valuable collaborators(MVCs)","Prolific and active researcher"]
    },
    {
        id: 8,
        name: "HDM",
...
citations at a faster speed for the paper under test.`,
         ...
         features : ["Global citations (references for overall paper)","Local citations (references for given context"]
    }
];
