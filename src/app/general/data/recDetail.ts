...
export const RecDetails: RecommenderDetail[] = [
    {
        id: 1,
        name: "BArC",
        fullName: "Basic Academic Recommender",
    ...
    },
    {
        id: 2,
        name: "LitRec",
        fullName: "Literature Recommender",
    ...
    },
    {
        id: 4,
        name: "RPRS",
        fullName: "Review Paper Recommender System",
        ...
        longDescription: `Peer review is an essential part of scientific communications. Scientific manuscripts and 
                ...
                The rapid growth of data volume and variety requires more advanced tools to help with academic data's exploration,
                and huge effort has been dedicated to facilitate various types of meaningful applications. Representative works
                include: reference recommendation, scholars' profiling and academic impact estimation. In addition to the above
                applications, peer review mining and recommendation has been regarded as an useful application in exploiting
                academic reviews, which aims to provide an appropriate review specific scores for individual reviews. Inspite
                of finding individual review sepecific scores, theere is a need of system which can help to decide the final
                decision of a paper based on the reviews of assigned reviewers. Consequently, obtaining useful and effective
                information from individual reviews which can influence the overall recomemndation, has become a complex task.
                Studies confirm that there is a strong relationship between sentiment analysis of reviews and the final
                recomemndation of the manucript.`,
    ...
    },
    {
        ...
        longDescription: `Generally researchers aspire to publish in suitable academic venues which acknowledge high-quality papers, 
                participate in academic conferences or workshops which are relevant to their area of research. In addition to the variety of
                challenges researchers’ face, an important task is identifying relevant publication opportunities which are further complicated
                by the continuous increase in the number of research areas and dynamic change in scope of journals. More and more collaborations
                are taking place between disciplines in the research landscape, which is leading to decreased compartmentalization.  Rapidly
                developing academic venues make it troublesome for researchers to recognize the ones that are most in-accordance with their
                scholarly interests and are of high significance. Notwithstanding when the quality or the proposal of a paper is great, the
                paper is rejected because of a mismatch between the area of the paper and the scope of the journal. Recommending great quality
                and valuable scholarly venues to researchers empowers them to recognize and partake in important academic conferences assisting
                them in contributing to influential journals. Each researcher knows the few best level venues for her specific field of interest,
                nevertheless a venue recommendation system particularly becomes helpful when exploring a new field or when more choices are required.
                We propose a hybrid personalized venue recommendation framework CNAVER which just requires title and abstract to assemble the learning
                base fundamental for generating meaningful recommendations.`,
    ...
    },
    {
        ...
        longDescription: `In academia, researchers collaborate with their peers to improve quality of research and thereby enhance academic 
                profiles. However, information overload in big scholarly data poses a challenge in identifying potential researchers for 
                fruitful collaboration. Consequently, obtaining insightful and effective information on potential collaborators has become 
                a complex task. With a growing number of research areas and dynamic changes in researchers interests, the scenario is 
                getting more complex nowadays.Recommending new collaborators to a target researcher, i.e., researchers with whom the 
                target researched has not worked with yet is a difficult task as potential collaborators need to similar in the research 
                area and also should be easily accessible. Research on big scholarly data and academic, social networks shows that scholars 
                in the context of collaboration prefer collaborators with whom they have not yet worked.To recommend the most influential
                collaborator for researchers, we need to focus our study from the perspective of a researcher's needs and development of
                the particular research area pertaining to the following issues.Who are the most prolific and active researchers who can
                provide professional academic guidance for a target researcher.How to obtain researchers who are having relevant research
                interest with target researcher.How to capture rapidly and temporarily changing nature of research trends and research
